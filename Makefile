...
INC_DIR   = ./src ./muduo/base ./muduo/net ./muduo/net/poller
...
$(obj-$1): $2%.o: %.$1  $(MAKEFILE_LIST)
	$(G++) $(inc_dir) -Wp,-MT,$@ -Wp,-MMD,$@.d $(CFLAGS) -c -o $$@ $$<  -std=c++11
...
$(TARGET): $(all_objs)
	$(LD) $(LDFLAGS) $(all_objs) -o $@  -lpthread -lrt -lncursesw
endif
	strip ./bin/UpdateSoftBatch
